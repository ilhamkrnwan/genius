<template>
  <nav class="fixed bottom-0 inset-x-0 z-40 bg-[#120a05]/95 border-t-4 border-[#5a3a18] backdrop-blur shadow-[0_-8px_25px_rgba(0,0,0,0.8)] select-none">
    <div class="max-w-6xl mx-auto w-full flex items-center justify-around sm:justify-center sm:gap-12 px-2 py-2 sm:py-3">
      <NuxtLink
        ...
        :class="[
          ...
          isActive(item.to)
            ? 'text-[#f0d060] font-bold scale-105 bg-[#2a1d13] border-2 border-[#f0d060] shadow-[0_0_15px_rgba(240,208,96,0.3)]'
            : 'text-[#c4956a] hover:text-[#f0e0c0] hover:bg-[#2a1d13]/50'
        ]"
      >
        <component
          :is="item.icon"
