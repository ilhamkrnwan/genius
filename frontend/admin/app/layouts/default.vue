<template>
  <div class="h-full w-full min-h-screen">
    ...
    >
      <BuddyHeader />
      <main class="flex-1 w-full max-w-6xl mx-auto pb-24 custom-scrollbar flex flex-col min-h-0 px-3 md:px-6 lg:px-8 pt-4 md:pt-6">
        <slot />
      </main>
      <BuddyBottomNav />
    </div>
    ...
    <!-- Global Modals & Notifications (Rendered once at root) -->
    <ToastContainer />
    <ConfirmationModal />
  </div>
</template>
