...
<template>
  <section id="rewards-section" class="relative py-16 sm:py-24 px-4 sm:px-6 bg-[#2d1b0e] text-[#f0e0c0]">
    <div class="relative z-10 max-w-5xl mx-auto">
      ...
      <!-- 3 Highlighted Rewards Cards -->
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
        <div
          v-for="(reward, idx) in rewards"
          :key="idx"
          class="sdv-card p-6 flex flex-col justify-between hover:-translate-y-1 hover:border-[#f0d060] transition-all group"
        >
          <div>
      ...
      <!-- Mini Top 3 Kelompok Leaderboard Teaser -->
      <div class="sdv-card-elevated p-6 sm:p-8 max-w-3xl mx-auto shadow-xl">
