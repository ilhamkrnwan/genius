...
export const RPG_CHARACTERS: Record<CharacterClass, RPGCharacterInfo> = {
  ...
  [CharacterClass.SHADOW_ASSASSIN]: {
    ...
    description: "Pengintai gesit yang bergerak cepat menembus rute di gedung kampus.",
    color: "#f43f5e",
...
export const TITLE_CATALOG: TitleDefinition[] = [
  ...
  },
  {
    ...
    category: "Eksplorasi",
    icon: "🗺️",
    description: "Menyelesaikan seluruh rute eksplorasi tanpa salah urutan pos.",
    unlockType: "POINTS",
    requiredPoints: 370,
    requiredTier: CharacterTier.ADVANCED,
  },
  ...
  {
    id: "TTL-076",
    title: "Penakluk Cakrawala Kampus",
    rarity: TitleRarity.SR,
    category: "Eksplorasi Kampus",
    icon: "🏰",
    description: "Menuntaskan seluruh stempel pos di seluruh gedung kampus.",
    unlockType: "POINTS",
    requiredPoints: 530,
    requiredTier: CharacterTier.MASTER,
  },
  ...
  {
    id: "TTL-090",
    title: "👑 The Living Legend of Campus Quest",
    rarity: TitleRarity.SSR,
    category: "Legenda Eksplorasi",
    icon: "👑",
    description: "Menyelesaikan seluruh 18 Corner Eksplorasi dengan skor 100% tanpa salah.",
    unlockType: "SPECIAL",
    requiredPoints: 700,
    requiredTier: CharacterTier.MASTER,
  },
