...
* **Lantai 6:** 
  * Pos 7 (Tebak Gambar & Rebus Budaya) — 5 Soal
...
| **Pos 7**<br>*(Lantai 6)* | **Fun Pos: Tebak Gambar & Rebus Budaya**<br>Riddle & Rebus Visual: Rumah Tongkonan, Burung Cenderawasih, Kuliner Gudeg, Rumah Gadang, Kerajaan Jenggolo. | **Tebak Gambar & Rebus** | `tebak_gambar` | [`TebakGambarGame.vue`](file:///c:/KAIRAV/project/genius_project/frontend/user/src/components/minigames/TebakGambarGame.vue) | `IMAGE_GUESS` | 5 Petunjuk multimedia dengan gambar lokal, MinIO S3, dan fallback Google Drive Iframe preview.<br>Skor: 5 soal x 20 = **100 Pts** |
